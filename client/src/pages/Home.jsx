        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-28">
            <motion.h1
              ...
              className="text4xl md:text-6xl font-semibold leading-tight max-w-4xl mx-auto"
            >
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className="border border-gray px-10 py-3 rounded-full
            ...
            {[
              {
                ...
                desc: "AI adjusts difiiculty based on selected job role.",
              },
              {
                icon: <BsMic size={24} />,
                step: "Step 2",
                title: "Smart Voice Interview",
                desc: "Dynamic floow-up questions based on your answers.",
              },
              {
          ...
          <div className="mb-32">
            ...
            >
              Advance AI{" "}
              <span className="text-green-500  "> Capabilities </span>
            </motion.h2>
              ...
              {[
                ...
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    <div className="w-full md:w-1/2 flex justify-centre">
                      <img
                        src={item.image}
                        alt={item.desc}
          ...
          <div className="mb-32">
            ...
            >
              Multiple Interview{" "}
              <span className="text-green-500  "> Modes </span>
            </motion.h2>
            <div className="grid md:grid-cols-2 gap-10">
              {[
                {
