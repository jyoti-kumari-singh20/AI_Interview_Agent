...
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "₹100",
      credits: 150,
      description: "Great for focuses practice and skill improvement.",
      features: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-16 px-6">
      <div className="max-w-6xl mx-auto mb-14 flex items-start gap-4">
        <button
          onClick={() => navigate("/")}
          className="pt-2 pt-3 rounded-full bg-white shadow hover:shadow-md transition"
        >
      ...
      >
        {plans.map((plan) => {
          return (
            ...
            ${
              isSelected
                ? "border-emerald-600 shadow-6xl bg-white"
            ...
            >
              ...
              {plan.default && (
                ...
                text-gray-700 text-xs px-4 py-1 rounded-full shadow"
                >
                  Default
                </div>
              )}
              <h3 className="text-gray-800 text-xl">{plan.name}</h3>
              <div className="mt-4">
